...
public class Level : Scene
{
    ...
    public override void Update()
    {
        ...
        var currentTile = Vector2.Parse(_map!)
            .FirstOrDefault(t => t.Item2 == _player!.Pos).Item1;
        ...
        if (_stairs.Contains(_player!.Pos))
        {
            GoToNextLevel();
        }
    ...
    private void initMapTileSets(string map)
    {
        ...
        foreach (var (c, p) in Vector2.Parse(map))
        {
            ...
            else if (c == '%')   // ✅ MOVE THIS UP
            {
                _stairs.Add(p);
                _door.Add(p); // walkable
            }
